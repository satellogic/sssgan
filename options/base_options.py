...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--residual_mode', action='store_true', help='add dense residual conections')
        
        # for instance-wise features
        parser.add_argument('--no_instance', action='store_true', help='if specified, do *not* add instance map as input')
        parser.add_argument('--no_global_descriptor', action='store_true', help='if specified, do *not* add satellite global vector')
