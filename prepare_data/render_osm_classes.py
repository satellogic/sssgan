...
# class_dict=OrderedDict({
#     "grass":set(["grass", "grass_2", "heath", "golf_course"]),
#     "forest": set(["forest", "forest_2", "forest-text", "orchard", "scrub"]),
#     "park": set(["park","campsite"]),
#     "land": set(["land-color", "bare_ground", "pedestrian-fill"]),
#     "block" : set(["church", "built-up-lowzoom", "construction", "construction_2", "built-up-z12", "societal_amenities", "tourism", "building-fill", "block_street"]),
#     "residential": set(["residential", "residential-line", "allotments"]),
#     "retail": set(["retail", "retail-line"]),
#     "commercial": set(["commercial", "commercial-line"]),
#     "industrial": set(["railway","railway-line", "industrial", "industrial-line", "wastewater_plant", "wastewater_plant-line", "industrial_2"]),
#     "farmland": set(["farmland", "farmland-line", "farmyard", "farmyard-line"]),
#     "transportation": set(["transportation-area", "apron", "rest_area"]),
#     "parking": set(["garages", "parking"]),
#     "religius":set(["cemetery", "place_of_worship"]),
#     "brownfield": set([ "quarry", "water_works", "water_works-line", "sand", "beach"]),
#     "sports": set(["pitch"]),
#     #Road
#     "motorway": set(["motorway-casing", "motorway-fill", "motorway-low-zoom", "motorway-low-zoom-casing", "motorway-shield"]),
#     "trunk": set(["trunk-casing", "trunk-fill", "trunk-low-zoom", "trunk-low-zoom-casing", "trunk-shield"]),
#     "higway": set(["primary-casing", "primary-fill", "primary-low-zoom", "primary-low-zoom-casing", "primary-shield",
#                     "secondary-casing", "secondary-fill", "secondary-low-zoom", "secondary-low-zoom-casing", "secondary-shield", "road-fill"
#                     ]),
#     "road": set(["default-casing", "tertiary-casing", "residential-casing", "tertiary-fill", "residential-fill", "living-street-fill"]),
