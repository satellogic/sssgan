...
if __name__=="__main__":
    ...
    parser.add_argument("--o", "--orig", type=str, default="./osm_renders_0.3")
    parser.add_argument("--r", "--ref", type=str, default="/datasets/INRIA/dataset")
    parser.add_argument("--d", "--dest", type=str, default="/datasets/INRIA/global_descriptor_vec")
    ...
    reference_path = os.path.join(args.r, "train", "images")

    #Define file structure
    path = {}
    path["global_vectors"] = args.d
